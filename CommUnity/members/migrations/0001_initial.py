    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('club', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='committees.associations')),
            ],
        ),
        migrations.CreateModel(
            name='Member',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notification_preference', models.CharField(choices=[('email', 'Email'), ('phone', 'Phone'), ('none', 'None')], default='email', max_length=10)),
                ('club', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='committees.associations')),
